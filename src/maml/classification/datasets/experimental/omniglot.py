...
from src.maml.classification.datasets.utils import get_asset

from src.maml.classification.datasets.base.class_dataset import ClassDataset
from src.maml.classification.datasets.base.combination_meta_dataset import CombinationMetaDataset
from src.maml.classification.datasets.base.dataset import Dataset
...
class Omniglot(CombinationMetaDataset):
    ...
    """
    def __init__(self, root, num_classes_per_task=None, meta_split=None, transform=None, target_transform=None,
        ...
        super(Omniglot, self).__init__(dataset, num_classes_per_task, target_transform=target_transform,
...
class OmniglotClassDataset(ClassDataset):
    ...
    def __init__(self, root, meta_split=None, use_vinyals_split=True, transform=None, class_augmentations=None,
                 download=False):
        super(OmniglotClassDataset, self).__init__(meta_split=meta_split, class_augmentations=class_augmentations)
        ...
        self.split_filename_labels = os.path.join(self.root,
            self.filename_labels.format('vinyals_' if use_vinyals_split else '', self.meta_split)
        )
    ...
    def __getitem__(self, index):
        ...
        return OmniglotDataset(index, data, character_name, transform=transform, target_transform=target_transform)
