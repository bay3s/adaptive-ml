...
class MultiHeadedMLPModule(nn.Module):
    ...
    def __init__(
      ...
      output_nonlinearities = self._check_parameter_for_output_layer('output_nonlinearities', output_nonlinearities,
                                                                     n_heads)
    ...
    def _check_parameter_for_output_layer(cls, var_name, var, n_heads):
      ...
      Raises:
        ValueError: if the variable is a list but length of the variable is not equal to n_heads
      """
